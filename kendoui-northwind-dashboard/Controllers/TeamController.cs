...
namespace KendoUI.Northwind.Dashboard.Controllers
{
    public class TeamController : Controller
    {
        ...
        public JsonResult EmployeesList([DataSourceRequest]DataSourceRequest request)
        {
            var employees = new NorthwindEntities().Employees.Select(e => new EmployeeViewModel
            {
                EmployeeID = e.EmployeeID,
        ...
        public JsonResult EmployeeSales([DataSourceRequest]DataSourceRequest request)
        {
        ...
        public JsonResult EmployeeAndTeamSales(int EmployeeID, DateTime startDate, DateTime endDate)
        {
            var northwind = new NorthwindEntities();
        ...
        public JsonResult EmployeeAverageSales(int EmployeeID, DateTime startDate, DateTime endDate)
        {
            var northwind = new NorthwindEntities();
        ...
        public JsonResult EmployeeQuarterSales(int EmployeeID, DateTime endDate)
        {
